...
*| adiwajshing/baileys
*|┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅
*| Mangga digunakan bang hehe. gw cuma bisa recode kok jangan di bully ya bg
*| Jangan lupa Kasih credit gw ya bang
*/
const
	{
		WAConnection,
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `SUBSCRIBE Fadhil Graphy`, 
                            orderTitle: `SUBSCRIBE Fadhil Graphy`,
                            thumbnail: nigambar, //Gambarnye
...
©Fadhil Graphy
`
fdhl.sendMessage(from, menunya, text, {quoted: ftrol})
	break   //┅┅┅┅〔 END MENU 〕┅┅┅┅//
...
//┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅〔 STICKER FEATURE 〕┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅//
     ...
     case 'attp':
         ...
         costum(buffer, sticker, Verived, `Jangan Lupa Subscribe Fadhil Graphy`)
         fs.unlinkSync(media)
         fs.unlinkSync(ran)
         })
     ...
     case 'tovideo':
         ...
         fs.unlinkSync(anum)
         buffer = fs.readFileSync(ran)
         fdhl.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Subscribe Zero YT7' })
         fs.unlinkSync(ran)
         })
         break
...
//┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅〔 OWNER FEATURE 〕┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅//
     ...
     case 'owner':
         ...
         reply('Save ya kak, biar banyak temen.')
         break
     case 'bc':
         ...
         for (let _ of anu) {
         fdhl.sendMessage(_.jid, bc, image, { caption: `[ Izin Broadcast ]\n\n${body.slice(4)}` })
         }
